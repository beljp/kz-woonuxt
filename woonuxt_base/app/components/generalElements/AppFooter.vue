...
<template>
  <footer class="bg-white order-last">
    ...
    <div class="container border-t pt-4 pb-6 flex flex-col items-center justify-center text-sm text-gray-500">
      <p class="mb-2">
  &copy; {{ new Date().getFullYear() }} Kledingzoeken.nl -
  <NuxtLink to="/partner-disclosure/" class="hover:underline">Partner disclosure</NuxtLink>
  -
  <NuxtLink to="/privacy-verklaring/" class="hover:underline">Privacy verklaring</NuxtLink>
</p>
      <SocialIcons />
    </div>
  </footer>
